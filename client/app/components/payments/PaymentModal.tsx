...
import { useCreatePaymentInline } from "~/hooks/usePayments";
...
export function PaymentModal({
  ...
  const createPayment = useCreatePaymentInline();
              ...
              <div className="flex items-center gap-3 mb-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-500 dark:text-neutral-400">
                    {invoiceNumber} — Saldo: {formatCurrency(remainingBalance)}
                  </p>
                </div>
              </div>
            </div>
