...
export function CustomerSelect({
  ...
  if (isLoading) {
    return (
      <div className={cn('h-12 w-64 animate-pulse rounded-xl bg-neutral-200 dark:bg-neutral-700', className)} />
    );
  }
      ...
      >
        ...
        <div className="flex flex-1 flex-col items-start truncate">
          {selectedCustomer ? (
            ...
            <span className="text-sm text-neutral-500">Seleccionar cliente...</span>
          )}
        </div>
