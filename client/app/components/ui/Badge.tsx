  ...
  "inline-flex items-center font-medium transition-colors",
  {
    variants: {
      variant: {
        ...
        "outline-primary":
          "border border-primary-300 text-primary-600 bg-transparent dark:border-primary-700 dark:text-primary-400",
        // Outline Success - Success border
        "outline-success":
          "border border-success-300 text-success-600 bg-transparent dark:border-success-700 dark:text-success-400",
        // Outline Warning - Warning border
        "outline-warning":
          "border border-warning-300 text-warning-600 bg-transparent dark:border-warning-700 dark:text-warning-400",
        // Outline Error - Error border
        "outline-error":
          "border border-error-300 text-error-600 bg-transparent dark:border-error-700 dark:text-error-400",
        // Gradient - Primary to accent gradient
        gradient:
          "bg-gradient-to-r from-primary-500 to-accent-500 text-white shadow-sm shadow-primary-500/25",
        // Gradient Success - Success gradient
        "gradient-success":
          "bg-gradient-to-r from-success-500 to-success-400 text-white shadow-sm shadow-success-500/25",
        // Glass - Glassmorphism style
        glass:
          "bg-white/70 dark:bg-neutral-900/70 backdrop-blur-md border border-white/20 dark:border-neutral-700/50 text-neutral-700 dark:text-neutral-300",
      },
      size: {
