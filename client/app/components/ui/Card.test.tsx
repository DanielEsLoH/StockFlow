...
describe("Card additional variants", () => {
  it("should render glass-elevated variant", () => {
    render(
      <Card variant="glass-elevated" data-testid="card">
        Glass Elevated
      </Card>,
    );
  ...
  it("should render gradient-border variant", () => {
    render(
      <Card variant="gradient-border" data-testid="card">
        Gradient Border
      </Card>,
    );
  ...
  it("should render soft-primary variant", () => {
    render(
      <Card variant="soft-primary" data-testid="card">
        Soft Primary
      </Card>,
    );
  ...
  it("should render soft-success variant", () => {
    render(
      <Card variant="soft-success" data-testid="card">
        Soft Success
      </Card>,
    );
  ...
  it("should render soft-warning variant", () => {
    render(
      <Card variant="soft-warning" data-testid="card">
        Soft Warning
      </Card>,
    );
  ...
  it("should render soft-error variant", () => {
    render(
      <Card variant="soft-error" data-testid="card">
        Soft Error
      </Card>,
    );
...
describe("Card additional padding sizes", () => {
  it("should render xs padding", () => {
    render(
      <Card padding="xs" data-testid="card">
        Content
      </Card>,
    );
...
describe("Card additional hover effects", () => {
  it("should render glow-accent hover effect", () => {
    render(
      <Card hover="glow-accent" data-testid="card">
        Content
      </Card>,
    );
  ...
  it("should render scale hover effect", () => {
    render(
      <Card hover="scale" data-testid="card">
        Content
      </Card>,
    );
...
describe("CardTitle gradient prop", () => {
  it("should apply gradient styles when gradient is true", () => {
    render(
      <CardTitle gradient data-testid="title">
        Gradient Title
      </CardTitle>,
    );
