...
describe('EmptyState', () => {
  describe('Default Type', () => {
    it('should render default empty state', () => {
      ...
      expect(screen.getByText('No hay informacion disponible en este momento.')).toBeInTheDocument();
    });
  ...
  describe('Products Type', () => {
    it('should render products empty state', () => {
      ...
      expect(screen.getByText('Comienza agregando tu primer producto al inventario.')).toBeInTheDocument();
    });
  });
  ...
  describe('Search Type', () => {
    it('should render search empty state', () => {
      ...
      expect(
        screen.getByText('No encontramos productos que coincidan con tu busqueda. Intenta con otros terminos.')
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Error Type', () => {
    it('should render error empty state', () => {
      ...
      expect(
        screen.getByText('Hubo un problema al cargar los datos. Por favor, intenta de nuevo.')
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Custom Description', () => {
    ...
    it('should override default description', () => {
      render(
        <EmptyState type="products" description="Add your first product to get started" />
      );

      expect(screen.getByText('Add your first product to get started')).toBeInTheDocument();
      expect(
        screen.queryByText('Comienza agregando tu primer producto al inventario.')
...
describe('InlineEmptyState', () => {
  ...
  describe('Custom ClassName', () => {
    it('should accept custom className', () => {
      const { container } = render(<InlineEmptyState className="custom-inline" />);
