...
describe('ConfirmModal', () => {
  ...
  describe('Variants', () => {
    it('should render danger variant with error styling', () => {
      ...
      const iconContainer = document.body.querySelector('[class*="bg-error-100"]');
    ...
    it('should render warning variant with warning styling', () => {
      ...
      const iconContainer = document.body.querySelector('[class*="bg-warning-100"]');
      expect(iconContainer).toBeInTheDocument();
    });
    ...
    it('should render default variant with primary styling', () => {
      ...
      const iconContainer = document.body.querySelector('[class*="bg-primary-100"]');
      expect(iconContainer).toBeInTheDocument();
    });
  });
});
...
describe('DeleteModal', () => {
  ...
  describe('Item Name', () => {
    it('should display the item name in the description', () => {
      ...
      expect(
        screen.getByText(/Estas seguro de que deseas eliminar "My Important Item"\?/)
      ).toBeInTheDocument();
    });
