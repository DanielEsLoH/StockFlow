...
describe('Pagination', () => {
  describe('Basic Rendering', () => {
    ...
    it('should have proper aria-label', () => {
      ...
      expect(screen.getByRole('navigation')).toHaveAttribute('aria-label', 'Paginacion');
    });
  ...
  describe('Previous Button', () => {
    it('should be disabled on first page', () => {
      ...
      const prevButton = screen.getByRole('button', { name: 'Pagina anterior' });
  ...
  describe('Next Button', () => {
    it('should be disabled on last page', () => {
      ...
      const nextButton = screen.getByRole('button', { name: 'Pagina siguiente' });
  ...
  describe('Page Number Buttons', () => {
    ...
    it('should mark current page with aria-current', () => {
      ...
      const currentPageButton = screen.getByRole('button', { name: 'Pagina 3' });
