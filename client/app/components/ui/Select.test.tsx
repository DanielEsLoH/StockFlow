...
describe("SelectField", () => {
  ...
  describe("Helper Text", () => {
    it("should render helper text when provided", () => {
      render(
        <SelectField options={mockOptions} helperText="Choose a category" />,
      );
  ...
  describe("Error Message", () => {
    ...
    it("should apply error styles when errorMessage is provided", () => {
      render(<SelectField options={mockOptions} errorMessage="Error" />);
...
describe("MultiSelect", () => {
  ...
  describe("Selection", () => {
    ...
    it("should call onChange with value removed when deselecting", () => {
      ...
      const dropdownButtons = container.querySelectorAll(
        '[class*="hover:bg-neutral"]',
      );
      const option1Button = Array.from(dropdownButtons).find((btn) =>
