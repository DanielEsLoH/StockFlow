...
const presetColors = {
  primary: {
    iconBg: 'bg-gradient-to-br from-primary-500/20 to-primary-600/10 dark:from-primary-500/20 dark:to-primary-900/30',
    iconColor: 'text-primary-600 dark:text-primary-400',
    accentBg: 'from-primary-500 to-accent-500',
  },
  accent: {
    iconBg: 'bg-gradient-to-br from-accent-500/20 to-accent-600/10 dark:from-accent-500/20 dark:to-accent-900/30',
    iconColor: 'text-accent-600 dark:text-accent-400',
    accentBg: 'from-accent-500 to-primary-500',
  },
  success: {
    iconBg: 'bg-gradient-to-br from-success-500/20 to-success-600/10 dark:from-success-500/20 dark:to-success-900/30',
    iconColor: 'text-success-600 dark:text-success-400',
    accentBg: 'from-success-500 to-success-400',
  },
  warning: {
    iconBg: 'bg-gradient-to-br from-warning-500/20 to-warning-600/10 dark:from-warning-500/20 dark:to-warning-900/30',
    iconColor: 'text-warning-600 dark:text-warning-400',
    accentBg: 'from-warning-500 to-warning-400',
  },
  error: {
    iconBg: 'bg-gradient-to-br from-error-500/20 to-error-600/10 dark:from-error-500/20 dark:to-error-900/30',
    iconColor: 'text-error-600 dark:text-error-400',
    accentBg: 'from-error-500 to-error-400',
  },
  neutral: {
    iconBg: 'bg-gradient-to-br from-neutral-200 to-neutral-100 dark:from-neutral-700 dark:to-neutral-800',
      ...
      <div className="flex items-center gap-1.5">
        <span
          className={cn(
            ...
            isNegative && 'bg-error-100 text-error-700 dark:bg-error-900/30 dark:text-error-400',
            isNeutral && 'bg-neutral-100 text-neutral-600 dark:bg-neutral-800 dark:text-neutral-400'
          )}
        >
        ...
        <div className="p-5">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className={cn(
              ...
              <Icon className={cn('h-7 w-7', finalIconColor)} aria-hidden="true" />
            </div>
          </div>
        </div>
      </Card>
    ...
    if (animate) {
      return (
        <motion.div
          ...
          transition={{ duration: 0.4, delay: animationDelay, ease: [0.16, 1, 0.3, 1] }}
        >
          {content}
        </motion.div>
      );
    ...
    const content = (
      ...
      >
        <div className="flex items-center gap-3">
          <div className={cn('flex h-10 w-10 items-center justify-center rounded-xl shrink-0', finalIconBg)}>
            <Icon className={cn('h-5 w-5', finalIconColor)} aria-hidden="true" />
          </div>
  ...
  const content = (
    ...
    >
      <div className="flex items-center gap-4">
        <div className={cn('flex h-12 w-12 items-center justify-center rounded-xl shrink-0', finalIconBg)}>
...
export function MiniStatCard({ label, value, icon: Icon, color = 'primary', trend }: MiniStatCardProps) {
  const colorScheme = presetColors[color];

  return (
    <div className="flex items-center gap-2 p-2 rounded-lg bg-neutral-50 dark:bg-neutral-800/50">
      {Icon && (
        <div className={cn('flex h-7 w-7 items-center justify-center rounded-lg', colorScheme.iconBg)}>
