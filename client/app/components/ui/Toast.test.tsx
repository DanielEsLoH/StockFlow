...
describe('Toast system', () => {
  ...
  describe('toast types styling', () => {
    it('success toast has success styling', () => {
      ...
      const toastElement = screen.getByText('Success message').closest('[class*="bg-success"]');
    ...
    it('error toast has error styling', () => {
      ...
      const toastElement = screen.getByText('Error message').closest('[class*="bg-error"]');
      expect(toastElement).toBeInTheDocument();
    });
    ...
    it('warning toast has warning styling', () => {
      ...
      const toastElement = screen.getByText('Warning message').closest('[class*="bg-warning"]');
      expect(toastElement).toBeInTheDocument();
    });
    ...
    it('info toast has primary styling', () => {
      ...
      const toastElement = screen.getByText('Info message').closest('[class*="bg-primary"]');
      expect(toastElement).toBeInTheDocument();
    });
  });
});