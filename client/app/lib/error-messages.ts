...
const errorMappings: ErrorMapping[] = [
  // Authentication errors
  {
    ...
    message: 'Ya existe una cuenta con este correo electronico. Intenta iniciar sesion o usa otro correo.',
  },
  {
    pattern: /invalid email or password/i,
    message: 'El correo o la contrasena son incorrectos. Por favor verifica tus datos.',
  },
  {
  ...
  },
  {
    ...
    message: 'Tu cuenta ha sido suspendida. Contacta al administrador para mas informacion.',
  },
  {
  ...
  },
  {
    ...
    message: 'El enlace de verificacion no es valido o ya fue utilizado. Solicita uno nuevo.',
  },
  {
  ...
  // Invitation errors
  {
    ...
    message: 'Esta invitacion ha expirado. Solicita una nueva invitacion al administrador.',
  },
  {
  ...
  // Organization/Tenant errors
  {
    ...
    message: 'Tu organizacion ha sido suspendida. Contacta a soporte para mas informacion.',
  },
  {
    pattern: /organization.*inactive/i,
    message: 'Tu organizacion esta inactiva. Contacta a soporte para reactivarla.',
  },
  ...
  },
  {
    ...
    message: 'No tienes permiso para realizar esta accion. Inicia sesion nuevamente.',
  },
  {
    pattern: /forbidden/i,
  ...
  },
  {
    ...
    message: 'Error de conexion. Verifica tu conexion a internet e intenta de nuevo.',
  },
  {
    pattern: /timeout/i,
...
function isUserFriendlyMessage(message: string): boolean {
  ...
  const spanishIndicators = /[áéíóúñ¿¡]|correo|usuario|contrasena|cuenta|error|intenta/i;

  // Check if message contains technical terms that indicate it's not user-friendly
  const technicalIndicators = /exception|error code|status|http|api|null|undefined|failed to|request failed/i;
