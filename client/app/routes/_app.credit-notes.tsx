...
import type { Route } from "./+types/_app.credit-notes";
...
export const meta: Route.MetaFunction = () => [
  { title: "Notas Credito - StockFlow" },
  { name: "description", content: "Gestion de notas credito electronicas" },
];
...
const filtersParser = {
  parse: (searchParams: URLSearchParams): CreditNoteFilters => ({
...
export default function CreditNotesPage() {
  ...
  const { filters, updateFilters, clearFilters } =
    useUrlFilters<CreditNoteFilters>({ parserConfig: filtersParser });
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <div className="flex-1">
                <p className="text-sm text-neutral-500">
                  Las notas credito se crean desde el detalle de cada factura
                  electronica.
                </p>
              </div>
              <Button
      ...
      <PageSection>
        <Card variant="elevated">
          {isLoading ? (
            ...
            <EmptyState
              type="error"
              title="Error al cargar notas credito"
              description="Hubo un problema al cargar las notas credito."
              action={{
                label: "Reintentar",
            ...
            <EmptyState
              icon={<FileMinus className="h-16 w-16" />}
              title={
                hasActiveFilters
                  ? "Sin resultados"
                  : "No hay notas credito"
              }
              description={
                hasActiveFilters
                  ? "No se encontraron notas credito con los filtros aplicados."
                  : "Las notas credito se generan desde el detalle de una factura electronica aceptada por la DIAN."
              }
              action={
                hasActiveFilters
