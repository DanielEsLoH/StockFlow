...
import type { Route } from "./+types/_app.debit-notes.$id";
...
export const meta: Route.MetaFunction = () => [
  { title: "Detalle Nota Debito - StockFlow" },
];
    ...
    return (
      <PageWrapper>
        <PageSection>
          <EmptyState
            type="error"
            title="Nota debito no encontrada"
            description="No se pudo encontrar la nota debito solicitada."
          ...
          <dl className="space-y-3">
            ...
            {(doc as any).creditNoteReason && (
              <div className="flex items-start gap-3">
                <FilePlus className="h-4 w-4 text-neutral-400 flex-shrink-0 mt-0.5" />
                <dt className="text-sm text-neutral-500 w-32">Razon</dt>
                <dd className="text-sm font-medium text-neutral-900 dark:text-white">
                  {debitNoteReasonLabels[
                    (doc as any).creditNoteReason as DebitNoteReason
                  ] || (doc as any).creditNoteReason}
                </dd>
              </div>
            )}
