...
export default function SystemAdminLoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-neutral-950">
      ...
      >
        {/* Card surface */}
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] p-8 shadow-2xl shadow-black/20 backdrop-blur-xl sm:p-10">
          {/* Logo + heading */}
          ...
          <motion.div
            ...
            className="mb-7 flex items-center gap-3 rounded-xl border border-primary-500/10 bg-primary-500/[0.06] px-4 py-3"
          >
            ...
            <AnimatePresence>
              {isLoggingIn && (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="absolute inset-0 z-10 flex items-center justify-center rounded-xl bg-neutral-950/60 backdrop-blur-[2px]"
                >
                  <motion.div
                    animate={{ rotate: 360 }}
                    transition={{
                  ...
                  >
                    <Fingerprint className="h-8 w-8 text-primary-400" />
                  </motion.div>
                </motion.div>
              )}
            </AnimatePresence>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`
                      flex h-11 w-full rounded-xl border bg-white/[0.04] px-4 text-sm text-white
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    onBlur={() => setFocusedField(null)}
                    className={`
                      flex h-11 w-full rounded-xl border bg-white/[0.04] px-4 pr-11 text-sm text-white
                      placeholder:text-neutral-600
                      transition-all duration-200
                      focus:outline-none
                      ${
