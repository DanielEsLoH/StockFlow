...
describe('settingsService', () => {
  ...
  describe('changePassword', () => {
    ...
    it('should throw error with incorrect current password', async () => {
      ...
      await expect(promise).rejects.toThrow('La contrasena actual es incorrecta');
    });
  ...
  describe('getPreferences', () => {
    it('should return preferences from localStorage', () => {
      ...
      localStorageMock.setItem('user-preferences', JSON.stringify(storedPreferences));
    ...
    it('should merge partial preferences with defaults', () => {
      ...
      localStorageMock.setItem('user-preferences', JSON.stringify(partialPreferences));
  ...
  describe('uploadAvatar', () => {
    ...
    it('should return correct filename', async () => {
      const file = new File(['avatar content'], 'my-avatar.jpg', { type: 'image/jpeg' });
    ...
    it('should handle PNG file type', async () => {
      const file = new File(['png content'], 'profile.png', { type: 'image/png' });
    ...
    it('should handle JPEG file type', async () => {
      const file = new File(['jpeg content'], 'photo.jpeg', { type: 'image/jpeg' });
    ...
    it('should handle JPG file type', async () => {
      const file = new File(['jpg content'], 'image.jpg', { type: 'image/jpeg' });
    ...
    it('should handle GIF file type', async () => {
      const file = new File(['gif content'], 'animated.gif', { type: 'image/gif' });
    ...
    it('should handle WebP file type', async () => {
      const file = new File(['webp content'], 'modern.webp', { type: 'image/webp' });
    ...
    it('should handle filename with spaces', async () => {
      const file = new File(['content'], 'my profile avatar.png', { type: 'image/png' });
    ...
    it('should handle filename with special characters', async () => {
      const file = new File(['content'], 'avatar_2024-01-15.png', { type: 'image/png' });
  ...
  describe('timing', () => {
    it('should complete updateProfile within timeout', async () => {
      const promise = settingsService.updateProfile('user-1', { firstName: 'Test' });
      vi.advanceTimersByTime(500);
      const result = await promise;
  ...
  describe('edge cases', () => {
    ...
    it('should handle large file upload', async () => {
      ...
      const file = new File([largeContent], 'large-avatar.png', { type: 'image/png' });
