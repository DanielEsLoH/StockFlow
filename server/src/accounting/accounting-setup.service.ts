...
const PUC_ACCOUNTS: PucAccountSeed[] = [
  ...
  {
    code: '2412',
    name: 'Impuesto sobre las Ventas Descontable',
    type: AccountType.LIABILITY,
    nature: AccountNature.CREDIT,
    parentCode: '24',
  },
  ...
  {
    code: '429505',
    name: 'Ajustes de Inventario (Sobrante)',
    type: AccountType.REVENUE,
    nature: AccountNature.CREDIT,
    parentCode: '4295',
  },
  ...
  {
    code: '519505',
    name: 'Ajustes de Inventario (Faltante)',
    type: AccountType.EXPENSE,
    nature: AccountNature.DEBIT,
    parentCode: '5195',
  },
  ...
  {
    code: '613505',
    name: 'Costo de Mercancias Vendidas',
    type: AccountType.COGS,
    nature: AccountNature.DEBIT,
    parentCode: '6135',
  },
  ...
  async setup(): Promise<{ message: string; accountsCreated: number }> {
    ...
    for (const seed of PUC_ACCOUNTS) {
      const parentId = seed.parentCode
        ? accountIdMap.get(seed.parentCode)
        : undefined;
    ...
    this.logger.log(
      `Accounting set up: ${PUC_ACCOUNTS.length} accounts created for tenant ${tenantId}`,
    );
