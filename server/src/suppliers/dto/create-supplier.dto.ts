 ...
 * Used by users with SUPPLIERS_CREATE permission to create suppliers within their tenant.
 */
export class CreateSupplierDto {
  ...
  /**
   * Supplier phone number (optional, 7-20 characters)
   ...
   * Defaults to NIT since suppliers are typically businesses
   * @example "NIT"
   */
  @ApiProperty({
  ...
  /**
   * Supplier address (optional, max 200 characters)
  ...
  /**
   * Supplier city (optional, max 100 characters)
   * @example "Bogota"
   */
  @ApiPropertyOptional({
  ...
  /**
   * Contact person name (optional, max 100 characters)
  ...
  /**
   * Contact person phone (optional, max 20 characters)
